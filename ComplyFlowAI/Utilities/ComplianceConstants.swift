...
enum ComplianceConstants {
    ...
    static let aiPrivacyText = "This App Store build uses local mock AI only. Inspection notes, photos, incident reports, SOP requests, audit details, business profile details, and reminders are not sent to any external AI service."
